...
export type ThumbnailBadge = "lab";
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blurb:
      "A thumb-first colour picker. Hue ribbon, tone plane, and a life-size thumb cursor on desktop so you can see exactly what a real finger covers.",
    description:
      "An experiment in thumb-first colour selection. A corner FAB expands into a hue ribbon and tone plane; layers lift and thicken as the touch approaches them so the colour you're aiming at never hides under your finger. On desktop the cursor is replaced with a life-size photograph of an actual thumb inside a Galaxy S24 mock — easier to evaluate exactly what gets covered on a real device.",
    meta: "Experiment · Personal",
    year: "2026",
    href: "/lab",
    external: false,
    ctaLabel: "Try it",
