...
The findings were both interesting and ridiculous, with all the models tested behaving in slightly different ways. To add a bit of rigour, I calculated the structural similarity index for each generated image compared with the original, this adds a nice charade of scientific investigation to an objectively stupid project.
