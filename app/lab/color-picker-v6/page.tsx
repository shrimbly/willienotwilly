...
import {
  ...
  type Config,
  type PickerControl,
} from "@/components/lab/color-picker-fab-v6";
...
export default function ColorPickerV6LabPage() {
    ...
    <div className="relative min-h-[100dvh] overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-200 dark:from-zinc-900 dark:to-zinc-950">
      <div className="mx-auto max-w-md px-6 pb-32 pt-16">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          Ribbon now exposes the full 360° hue wheel; swatches are quick-pick
          presets that no longer bound the ribbon&rsquo;s range.
        </p>
      ...
      <ColorPickerFabV6 config={config} control={control} />
    </div>
  );
}
