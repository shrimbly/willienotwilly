...
import {
  ...
  type Config,
  type PickerControl,
} from "@/components/lab/color-picker-fab-v7";
import { TuningPanelV7 as TuningPanel } from "@/components/lab/tuning-panel-v7";
...
export default function ColorPickerV7LabPage() {
    ...
    <div className="relative min-h-[100dvh] overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-200 dark:from-zinc-900 dark:to-zinc-950">
      <div className="mx-auto max-w-md px-6 pb-32 pt-28">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          Adds a third layer: a thick tone-plane arc beyond the ribbon. Drag
          past the ribbon to enter — hue locks in, tangential picks chroma,
          radial picks lightness.
        </p>
      ...
      <ColorPickerFabV7 config={config} control={control} />
    </div>
  );
}
