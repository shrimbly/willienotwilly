...
import {
  ...
  type Config,
  type PickerControl,
} from "@/components/lab/color-picker-fab-v5";
...
export default function ColorPickerV5LabPage() {
    ...
    <div className="relative min-h-[100dvh] overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-200 dark:from-zinc-900 dark:to-zinc-950">
      <div className="mx-auto max-w-md px-6 pb-32 pt-28">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          Swatches scale and fade in on an ease-out curve. Hovering a swatch
          previews the ribbon as a white outline.
        </p>
      ...
      <ColorPickerFabV5 config={config} control={control} />
    </div>
  );
}
